...
SBT_ARGS="
  test:runMain 
  -DCARBONTESTS_TARGET=$SILICONTESTS_TARGET
  -DCARBONTESTS_WARMUP=$SILICONTESTS_WARMUP 
  -DCARBONTESTS_REPETITIONS=$SILICONTESTS_REPETITIONS 
  -DCARBONTESTS_CSV=$SILICONTESTS_CSV 
  -DCARBONTESTS_INCL_FILE=$SILICONTESTS_INCL_FILE 
  -DCARBONTESTS_TIMEOUT=$SILICONTESTS_TIMEOUT   
  -DCARBONTESTS_RANDOMIZE_Z3=$SILICONTESTS_RANDOMIZE_Z3   
